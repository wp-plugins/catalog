...
var keyCode = event.keyCode ? event.keyCode : event.which ? event.which : event.charCode;
    ...
    <td  style="width:90px; text-align:right;"><p class="submit" style="padding:0px; text-align:left"><input type="button" value="Add a Product" name="custom_parametrs" onclick="window.location.href='admin.php?page=Products_Spider_Catalog&task=add_prad'" /></p></td>
...
Get the full version&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <th scope="col" id="name" class="<?php if($sort["sortid_by"]=="name") echo $sort["custom_style"]; else echo $sort["default_style"]; ?>" style="" ><a href="javascript:ordering('name',<?php if($sort["sortid_by"]=="name") echo $sort["1_or_2"]; else echo "1"; ?>)"><span>Name</span><span class="sorting-indicator"></span></a></th>
  <th scope="col" id="cost" class="<?php if($sort["sortid_by"]=="cost") echo $sort["custom_style"]; else echo $sort["default_style"]; ?>" style="" ><a href="javascript:ordering('cost',<?php if($sort["sortid_by"]=="cost") echo $sort["1_or_2"]; else echo "1"; ?>)"><span>Price</span><span class="sorting-indicator"></span></a></th>
<th scope="col" id="Category" class="<?php if($sort["sortid_by"]=="Category") echo $sort["custom_style"]; else echo $sort["default_style"]; ?>" style="" ><a href="javascript:ordering('Category',<?php if($sort["sortid_by"]=="Category") echo $sort["1_or_2"]; else echo "1"; ?>)"><span>Category</span><span class="sorting-indicator"></span></a></th>
 ...
 <tr>
         ...
         <td><a  href="admin.php?page=Products_Spider_Catalog&task=edit_prad&id=<?php echo $rows[$i]->id?>"><?php echo $rows[$i]->name; ?></a></td>
         ...
         <td><a  href="admin.php?page=Products_Spider_Catalog&task=unpublish_prad&id=<?php echo $rows[$i]->id?>"<?php if(!$rows[$i]->published){ ?> style="color:#C00;" <?php }?> ><?php if($rows[$i]->published)echo "Yes"; else echo "No"; ?></a></td>
         <td ><a  href="admin.php?page=Products_Spider_Catalog&task=edit_prad&id=<?php echo $rows[$i]->id?>">Edit</a></td>
         <td><a  href="admin.php?page=Products_Spider_Catalog&task=remove_prod&id=<?php echo $rows[$i]->id?>">Delete</a></td>
  </tr> 
 <?php } ?>
 </tbody>
 </table>
...
Get the full version&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <td align="right"><input type="button" onclick="submitbutton('edit_reviews')" value=" Edit Reviews " class="button-primary action"> </td> 
  ...
  <td align="right"><input type="button" onclick="window.location.href='admin.php?page=Products_Spider_Catalog'" value="Cancel" class="button-secondary action"> </td> 
  </tr>
  </tbody></table>
  <br /><br />
<form action="admin.php?page=Products_Spider_Catalog&id=<?php echo $row->id?>" method="post" name="adminForm" id="adminForm">
...
<div id="upload_div_1">
<input type="text"  id="image_no_1" value="" onchange="add_upload('1');" class="text_input" style="width:200px;"><a id="upload_href_1" class="button lu_upload_button" href="javascript:narek('1');">Select</a><input type="button" value="X" title="Delete" onclick="remov_upload('1')" /><br>
</div>
</td>
<tr>
<td id="added_images">
...
Get the full version&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <td  style="width:90px; text-align:right;"><p class="submit" style="padding:0px; text-align:left"><input type="button" value="Cancel" name="custom_parametrs" onclick="window.location.href='admin.php?page=Products_Spider_Catalog&task=edit_prad&id=<?php echo $id ?>'" /></p></td>
<td style="text-align:right;font-size:16px;padding:20px; padding-right:50px">
 ...
 <th scope="col" id="remote_ip" class="<?php if($sort["sortid_by"]=="remote_ip") echo $sort["custom_style"]; else echo $sort["default_style"]; ?>" style="width:110px" ><a href="javascript:ordering('remote_ip',<?php if($sort["sortid_by"]=="id") echo $sort["1_or_2"]; else echo "1"; ?>)"><span>Remote Ip</span><span class="sorting-indicator"></span></a></th>
 <th scope="col" id="name" class="<?php if($sort["sortid_by"]=="name") echo $sort["custom_style"]; else echo $sort["default_style"]; ?>" style="" ><a href="javascript:ordering('name',<?php if($sort["sortid_by"]=="name") echo $sort["1_or_2"]; else echo "1"; ?>)"><span>Name</span><span class="sorting-indicator"></span></a></th>
 <th scope="col" id="content" class="<?php if($sort["sortid_by"]=="content") echo $sort["custom_style"]; else echo $sort["default_style"]; ?>" style="" ><a href="javascript:ordering('content',<?php if($sort["sortid_by"]=="content") echo $sort["1_or_2"]; else echo "1"; ?>)"><span>Message</span><span class="sorting-indicator"></span></a></th>
 ...
 <tr>
         ...
         <td><a  href="admin.php?page=Products_Spider_Catalog&task=delete_review&id=<?php echo $id; ?>&del_id=<?php echo $rows[$i]->id?>">Delete</a></td>
  </tr> 
 <?php } ?>
 </tbody>
 </table>
...
Get the full version&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <td  style="width:90px; text-align:right;"><p class="submit" style="padding:0px; text-align:left"><input type="button" value="Save" name="custom_parametrs" onclick="submit_button('s_p_save_rating')" /></p></td>
    <td  style="width:90px; text-align:right;"><p class="submit" style="padding:0px; text-align:left"><input type="button" value="Apply" name="custom_parametrs" onclick="submit_button('s_p_apply_rating')" /></p></td>
    <td  style="width:90px; text-align:right;"><p class="submit" style="padding:0px; text-align:left"><input type="button" value="Cancel" name="custom_parametrs" onclick="window.location.href='admin.php?page=Products_Spider_Catalog&task=edit_prad&id=<?php echo $id ?>'" /></p></td>
<td style="text-align:right;font-size:16px;padding:20px; padding-right:50px">
 ...
 <tr>
 <th scope="col" id="cb" class="manage-column column-cb check-column"><input type="checkbox"></th>
 <th scope="col" id="remote_ip" class="<?php if($sort["sortid_by"]=="remote_ip") echo $sort["custom_style"]; else echo $sort["default_style"]; ?>" style="width:110px" ><a href="javascript:ordering('remote_ip',<?php if($sort["sortid_by"]=="remote_ip") echo $sort["1_or_2"]; else echo "1"; ?>)"><span>Remote Ip</span><span class="sorting-indicator"></span></a></th>
 <th scope="col" id="vote_value" class="<?php if($sort["sortid_by"]=="vote_value") echo $sort["custom_style"]; else echo $sort["default_style"]; ?>" style="" ><a href="javascript:ordering('vote_value',<?php if($sort["sortid_by"]=="vote_value") echo $sort["1_or_2"]; else echo "1"; ?>)"><span>Vote Value</span><span class="sorting-indicator"></span></a></th>
 ...
 <tr>
 		 <th scope="row" class="check-column"><input type="checkbox" name="post[]" value="<?php echo $rows[$i]->id; ?>"></th>
         <td><?php echo $rows[$i]->remote_ip; ?></td>
         <td><select name="vote_<?php echo $rows[$i]->id; ?>" id="vote_<?php echo $rows[$i]->id; ?>" class="inputbox"><option <?php if($rows[$i]->vote_value==1) echo 'selected="selected"';?>  value="1">1</option><option <?php if($rows[$i]->vote_value==2) echo 'selected="selected"';?> value="2">2</option><option <?php if($rows[$i]->vote_value==3) echo 'selected="selected"';?> value="3">3</option><option <?php if($rows[$i]->vote_value==4) echo 'selected="selected"';?> value="4">4</option><option <?php if($rows[$i]->vote_value==5) echo 'selected="selected"';?> value="5">5</option></select></td>
         <td><a  href="admin.php?page=Products_Spider_Catalog&task=delete_rating&id=<?php echo $id; ?>&del_id=<?php echo $rows[$i]->id?>">Delete</a></td>
  </tr> 
 <?php } ?>
 </tbody>
 </table>
